...
\draw [arrow, color = tabblue] (r1) -- node[anchor=south] {} (r4) ;
\draw [arrow, color = tabblue] (r2) -- node[anchor=south] {} (r6) ;
...
\node(r8)[startstop, xshift = - 1.75cm, yshift = -1.3cm, draw =none, color = tabblue, align=center] {\footnotesize Decision rule \\ \footnotesize $a_t^{\pi}(s_t)$ };
\node(r9)[startstop, xshift= 4.2cm, yshift = -1.3cm, draw =none, color =tabblue, align = center] {\footnotesize Decision rule \\ \footnotesize $a_{t+1}^{\pi}(s_{t+1})$ };

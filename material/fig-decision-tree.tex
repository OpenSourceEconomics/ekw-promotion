...
% First level: BLUE
\node [env, top color = tabblue, bottom color = tabblue, scale = 0.8] (1) at (-5,-4.2) {\textbf{Blue}};
\draw[->, thick] (0) edge node[left of = 0, rotate = 72.75, node distance = 0.3cm]{} (1);
% Second level: Blue, White, Military, School, Home
\node [env, top color = tabblue, bottom color = tabblue, scale = 0.55] (11) at (0,-5) {Blue};
\draw[->] (1) edge (11);
\node [env, top color = tabred, bottom color = tabred, scale = 0.55] (12) at (0,-4.6) {White};
\draw[->] (1) edge (12);
\node [env, top color = tabpurple, bottom color = tabpurple, scale = 0.55] (13) at (0,-4.2) {Military};
\draw[->] (1) edge (13);
\node [env, top color = taborange, bottom color = taborange, scale = 0.55] (14)  at (0,-3.8) {School};
\draw[->] (1) edge (14);
\node [env, top color = tabgreen, bottom color = tabgreen, scale = 0.55] (15)  at (0,-3.4) {Home};
\draw[->] (1) edge (15);
...
%First level: WHITE
\node [env, top color = tabred, bottom color = tabred, scale = 0.8] (2) at (-5,-2.1) {\textbf{White}};
\draw[->, thick] (0) edge node[right of = 0, yshift = 0.35cm,  rotate = 41.0, node distance = 0cm]{} (2);
% Second level: Blue, White, Military, School, Home
\node [env, top color = tabblue, bottom color = tabblue, scale = 0.55] (21) at (0,-2.9) {Blue};
\draw[->] (2) edge (21);
\node [env, top color = tabred, bottom color = tabred, scale = 0.55] (22) at (0,-2.5) {White};
\draw[->] (2) edge (22);
\node [env, top color = tabpurple, bottom color = tabpurple, scale = 0.55] (23) at (0,-2.1) {Military};
\draw[->] (2) edge (23);
\node [env, top color = taborange, bottom color = taborange, scale = 0.55] (24)  at (0,-1.7) {School};
\draw[->] (2) edge (24);
\node [env, top color = tabgreen, bottom color = tabgreen, scale = 0.55] (25)  at (0,-1.3) {Home};
\draw[->] (2) edge (25);
...
\node [env, top color = tabpurple, bottom color = tabpurple, scale = 0.8] (3) at (-5,0) {\textbf{Military}};
\draw[->, thick] (0) edge node[right of = 0, yshift = 0.25cm, node distance = 0.2cm]{} (3);
% Second level: Blue, White, Military, School, Home
\node [env, top color = tabblue, bottom color = tabblue, scale=0.55] (31) at (0,-0.8) {Blue};
\draw[->] (3) edge (31);
\node [env, top color = tabred, bottom color=tabred, scale = 0.55] (32) at (0,-0.4) {White};
\draw[->] (3) edge (32);
\node [env, top color = tabpurple, bottom color = tabpurple, scale = 0.55] (33) at (0,0.0) {Military};
\draw[->] (3) edge (33);
\node [env, top color = taborange, bottom color = taborange, scale = 0.55] (34)  at (0,0.4) {School};
\draw[->] (3) edge (34);
\node [env, top color = tabgreen, bottom color = tabgreen, scale = 0.55] (35)  at (0,0.8) {Home};
\draw[->] (3) edge (35);
% Second level --> third level
...
% First Level: SCHOOL
\node [env, top color = taborange, bottom color = taborange, scale = 0.8] (4)  at (-5,2.1) {\textbf{School}};
\draw[->, thick] (0) edge node[right of = 0, yshift = 0.1cm, rotate = -38, node distance = 0.25cm]{} (4);
% Second level: Blue, White, Military, School, Home
\node [env, top color = tabblue, bottom color = tabblue, scale = 0.55] (41) at (0,1.3) {Blue};
\draw[->] (4) edge (41);
\node [env, top color = tabred, bottom color = tabred, scale = 0.55] (42) at (0,1.7) {White};
\draw[->] (4) edge (42);
\node [env, top color = tabpurple, bottom color = tabpurple, scale = 0.55] (43) at (0,2.1) {Military};
\draw[->] (4) edge (43);
\node [env, top color = taborange, bottom color = taborange, scale = 0.55] (44)  at (0,2.5) {School};
\draw[->] (4) edge (44);
\node [env, top color = tabgreen, bottom color = tabgreen, scale = 0.55] (45)  at (0,2.9) {Home};
\draw[->] (4) edge (45);
% Second level --> third level
...
% First Level: HOME
\node [env, top color = tabgreen, bottom color = tabgreen, scale = 0.8] (5)  at (-5,4.2) {\textbf{Home}};
\draw[->, thick] (0) edge node[right of = 0, yshift=0.25cm, rotate = -72.75, node distance = 0.15cm]{} (5);
%\draw[->, thick] (0) edge (5);
% Second level: Blue, White, Military, School, Home
\node [env, top color = tabblue, bottom color = tabblue, scale = 0.55] (51)  at (0,3.4) {Blue};
\draw[->] (5) edge (51);
\node [env, top color = tabred, bottom color = tabred, scale = 0.55] (52)  at (0,3.8) {White};
\draw[->] (5) edge (52);
\node [env, top color = tabpurple, bottom color = tabpurple, scale = 0.55] (53) at (0,4.2) {Military};
\draw[->] (5) edge (53);
\node [env, top color = taborange, bottom color = taborange, scale = 0.55] (54) at (0,4.6) {School};
\draw[->] (5) edge (54);
\node [env, top color = tabgreen, bottom color = tabgreen, scale = 0.55] (55) at (0,5.0) {Home};
\draw[->] (5) edge (55);
% Second level --> third level

...
\begin{figure}[t!]\centering
	\scalebox{0.75}{%
		...
		\input{../material/fig-decision-tree}%
	}
...
\end{align}
%
%\comment[id=HG]{The use of the indicator function here is a~bit unusual. The way I understand \url{https://en.wikipedia.org/wiki/Iverson_bracket} and \url{https://en.wikipedia.org/wiki/Indicator_function}, you use either the Iverson bracket or the indicator function but not a~mixture of the two.}
%

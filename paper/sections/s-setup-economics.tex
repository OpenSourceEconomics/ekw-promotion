...
%
\begin{figure}
		\caption{Timing of events}\label{Timing}\vspace{1.0cm}\centering
	\scalebox{0.755}{
\input{../material/fig_timing.tex}}
\end{figure}
%

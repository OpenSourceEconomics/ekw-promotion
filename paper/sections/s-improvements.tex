...
\end{align*}
%
%\comment[id=HG]{Darf man das so schreiben?! Ich meine, darf man dieselbe Variable $\bm{\epsilon}$ als Integralgrenzen/\hspace{0pt}Menge, über die integriert wird, nehmen und dann in $\text{d}\bm{\epsilon}$ reinpacken?}%

...
\title{%
	\sffamily\bfseries%
	\papertitle%
	\thanks{Corresponding author: Philipp Eisenhauer, \email{p.eisenhauer@uni-bonn.de}. We thank Jano\'s Gabler, Annica Gehlen, Holger Gerhardt, Boryana Ilieva, Fedor Ishakov, Lena Janys, Moritz Mendel, Tim Mensinger, Tobias Raabe, Klara R\"ohrl, John Rust, and Rafael Suchy for their valuable input. Julian König and Luis Wardenbach provided outstanding research assistance.}
}

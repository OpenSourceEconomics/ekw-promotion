...
\begin{figure}[b!]\centering
	...
	% From slides:
	\lstset{basicstyle=\footnotesize\ttfamily, language=python, morekeywords={as}, ndkeywords={=}, ndkeywordstyle=\color{blue}, numbers=left, keywordstyle=\color{darkgray}, commentstyle=\color{gray}, emph={get_example_model, get_crit_func, get_simulate_func}, emphstyle=\color{darkgray}}

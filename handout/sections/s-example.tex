...
\scalebox{0.35}{\includegraphics{fig-observed-choices-bw}}
...
\subfloat[Parameterization]{\scalebox{0.48}{\includegraphics{params-crop.pdf}}}\hspace{0.3cm}
\subfloat[Options]{\scalebox{0.48}{\includegraphics{options.pdf}}}
\end{figure}\FloatBarrier

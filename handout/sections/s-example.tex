...
\subfloat[Choices]{\scalebox{0.25}{\includegraphics{material/fig-observed-data-choices-bw-TMP}}}\hspace{0.3cm}
\subfloat[Wages]{\scalebox{0.25}{\includegraphics{material/fig-observed-wage-mean-bw-TMP}}}
\begin{center}

...
\subfloat[Time preference]{\scalebox{0.25}{\includegraphics{fig-economic-mechanisms-colored}}}\hspace{0.3cm}
\subfloat[Tuition subsidy]{\scalebox{0.25}{\includegraphics{fig-policy-forecast-colored}}}
\end{figure}\FloatBarrier

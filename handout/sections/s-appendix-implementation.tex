...
\input{material/tab-model-parameters-civilian}
...
\input{material/tab-model-parameters-military}
% ------------------------------------------------------------------------------
...
\input{material/tab-model-parameters-school}
...
\input{material/tab-model-parameters-home}

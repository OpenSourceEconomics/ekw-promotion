...
\input{../material/material-appendix/tab-basic-data-structure}
...
\input{../material/material-appendix/tab-total-choices}
\input{../material/material-appendix/tab-relative-choices}
%\begin{figure}[h]\centering
...
\newpage
\input{../material/material-appendix/tab-average-wages}
%\begin{figure}[h]\centering
...
%\input{../material/material-appendix/tab-initial-schooling}
\begin{figure}[h]\centering
...
\input{../material/material-appendix/tab-initial-schooling-activity}
...
\includegraphics[scale=0.6]{material-appendix/fig-heatmap-transitionprobs-bw}
\end{figure}
%\input{../material/material-appendix/tab-transition-probabilities-origin-to-destination}
...
\includegraphics[scale=0.6]{material-appendix/fig-heatmap-transitionprobs-from-origin-bw}
\end{figure}
%\input{../material/material-appendix/tab-transition-probabilities-destination-to-origin}
...
\includegraphics[scale=0.6]{material-appendix/fig-heatmap-transitionprobs-bw-15-included}
\end{figure}

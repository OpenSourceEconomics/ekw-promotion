...
\input{../material/tab-basic-data-structure}
...
\input{../material/tab-total-choices}
\input{../material/tab-relative-choices}
%\begin{figure}[h]\centering
...
\newpage
\input{../material/tab-average-wages}
%\begin{figure}[h]\centering
%	\caption{Wage moments by age.}\label{fig:WageMoments}
%	\subfloat[White-collar]{\scalebox{0.38}{\includegraphics{fig-observed-wage-mean}}}\hspace{0.3cm}
%	\subfloat[Military]{\scalebox{0.38}{\includegraphics{fig-observed-wage-std}}} 
...
\input{../material/tab-initial-schooling}
\begin{figure}[h]\centering
...
\input{../material/tab-initial-schooling-activity}
...
\input{../material/tab-transition-probabilities-origin-to-destination}
...
\input{../material/tab-transition-probabilities-destination-to-origin}
...
\input{../material/tab-transition-probabilities-imputing}

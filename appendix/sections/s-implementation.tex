...
%-------------------------------------------------------------------------------
The per-period utility from working in a white-collar occupation is specified analogously. Equation (\ref{eq:SkillLevelWhiteCollar}) shows the parameterization of the deterministic component of the skill production function.
%
...
\end{align}
%
\noindent Equation (\ref{eq:UtilityWhiteCollar}) shows the parameterization of the non-pecuniary utilities from working in a white-collar occupation.
%

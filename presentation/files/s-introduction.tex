...
%-------------------------------------------------------------------------------
  ...
  \begin{columns}[t]
  	...
  	\centering \\
  	% DIW Berlin
  	\includegraphics[width=0.6\textwidth]{fig-cooperation-diw.png}\\
  	\vspace{1.0cm}
  	% Institute for Numerical Simulation
  	\includegraphics[width=0.45\textwidth]{fig-cooperation-ins.png} \\
  	\vspace{-0.5cm}
  	\footnotesize{Institute for \\ Numerical Simulation}
  	\column{.5\textwidth}
  	\centering \\
  	% Statistics Norway
  	\includegraphics[width=0.75\textwidth]{fig-cooperation-ssb.png} \\
  	\vspace{-0.2cm}
  \end{columns}
  \end{frame}
%-------------------------------------------------------------------------------

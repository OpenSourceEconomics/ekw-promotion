...
\begin{frame}{Data descriptives}
  ...
  \subfloat[Choices]{\scalebox{0.225}{\includegraphics{fig-data-choice-all}}}\hspace{0.5cm}
  \subfloat[Wages]{\scalebox{0.225}{\includegraphics{fig-data-wage-occupations}}}
  \end{figure}
\end{frame}
%---------------------------------------------------------------------------------------------------
%---------------------------------------------------------------------------------------------------
\begin{frame}{Calibration results}
  \begin{figure}[h!]\centering
  \subfloat[Blue-collar]{\scalebox{0.225}{\includegraphics{fig-model-fit-choice-blue}}}\hspace{0.5cm}
  \subfloat[Average wage]{\scalebox{0.225}{\includegraphics{fig-model-fit-wage-all}}}

...
\centering \\  \vspace{-1.9cm}
	\includegraphics[width=0.25\textwidth]{crop-cooperation-ins.png} \\\vspace{-0.5cm}
	\footnotesize{Institute for \\ Numerical Simulation}\vspace{0.3cm}   \\ \vspace{0.5cm}
	\includegraphics[width=0.45\textwidth]{crop-cooperation-diw.png} \\ \vspace{0.95cm}
 	\includegraphics[width=0.4\textwidth]{Limes.png}
	...
	\includegraphics[width=0.575\textwidth]{crop-cooperation-ssb.png} \\ \vspace{0.85cm}
 	...
 	\vspace{0.85cm}
 	\includegraphics[width=0.4\textwidth]{Fraunhofer.png}
